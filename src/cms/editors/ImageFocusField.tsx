...
const nudgeButtonClass =
  'flex h-9 w-9 shrink-0 items-center justify-center rounded-lg border border-neutral-200 bg-white text-sm font-medium text-neutral-700 hover:bg-neutral-50 disabled:opacity-30'
            ...
            >
              ...
              {resolved ? (
                <span
                  ...
                  aria-hidden
                >
                  <span className="absolute inset-0 rounded-full border-2 border-white shadow-[0_0_0_1px_rgba(0,0,0,0.45)]" />
          ...
          <p className="pointer-events-none absolute inset-x-0 bottom-3 z-[3] text-center type-label text-[0.55rem] tracking-[0.14em] text-white/70 uppercase">
            ...
            <div className="mt-3 flex flex-wrap items-center gap-2">
              <button
                ...
                className="cms-secondary-action rounded-lg border border-neutral-200 bg-white px-3 py-1.5 text-[11px] font-medium text-neutral-600 hover:bg-neutral-50 disabled:opacity-30"
              >
                Centreer
              </button>
              <button
          ...
          <div>
            ...
            <div className="flex items-center gap-2">
              ...
              <input
                ...
                className="h-1.5 w-full accent-neutral-600 disabled:opacity-40"
