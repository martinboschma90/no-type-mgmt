    ...
    >
      ...
      >
          ...
          <div className="absolute inset-0 overflow-hidden">
            <div className="absolute inset-0 origin-center transition-transform duration-[600ms] ease-out will-change-transform group-hover:scale-[1.04] motion-reduce:transition-none motion-reduce:group-hover:scale-100">
              <OptimizedImg
                ...
                style={frame}
                size="card"
                srcSetSizes={priority ? ['card', 'hero'] : ['card']}
        ...
        <div className="absolute inset-x-0 bottom-0 z-[2] flex flex-col items-start gap-2.5 px-4 pb-4 sm:px-5 sm:pb-5">
          <span className="type-ui inline-flex translate-y-3 items-center rounded-full bg-brand px-3 py-1.5 text-[0.7rem] tracking-[0.06em] text-[#111111] opacity-0 transition-[opacity,transform] duration-[350ms] ease-out group-hover:translate-y-0 group-hover:opacity-100 group-hover:delay-100 motion-reduce:translate-y-0 motion-reduce:opacity-100 motion-reduce:transition-none">
            More →
          </span>
